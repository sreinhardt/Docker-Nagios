...
# Global vars
logfile="/var/log/nagiosim.log"
initdir="/etc/init.d"
tarball="http://assets.nagios.com/downloads/nagiosim/nagiosim-latest.tar.gz"
tar_file="nagiosim_latest.tar.gz"
tar_dir="nagiosim"
default_services_start="mysqld httpd crond"
default_services_stop="crond httpd mysqld"
...
This script is intended start and stop a variety of services in a docker container. While not very docker-ish, it does serve a porpouse.
